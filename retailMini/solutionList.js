var answers = [
    ...
    new Solution([
        ...
        ['f','r','a','y'],
        ['t','o','s','s']],
        ['Simon favorite new starter. An unwanted plant. A bad plants you murder when you garden.',
        'Inner glow. An ambiance exuded by a person. A magical glowy thing around your body.',
        'Bad string. Enter the ____ (Join a competition). What happens to rope after a while.',
        'Have a catch with dad. Throw away. I ____ the live hand grenade at Bert for being a twerp.',
