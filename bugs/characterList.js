...
export const CHARACTERLIST = [
    {
        ...
        shoot: function(item, xt, yt, size, fraction) {
            entityList.push(new Bullet(item.x + size*fraction/2, item.y + size*fraction/2, xt - item.x, yt - item.y, 40, 0.03, 0.1, 70, 10, 30, "goop.svg"));
        },
        "feral": false,
        "cooldown": 10,
        "point": true,
    },
    {
        ...
        shoot: function(item, xt, yt, size, fraction) {
            entityList.push(new Bullet(item.x + size*fraction/2, item.y + size*fraction/2, xt - item.x, yt - item.y, 50, 0.1, 0.3, 40, 10, 10, "fire.svg"));
        },
        "feral": true,
        "cooldown": 4,
        "point": true,
    },
    {
        ...
        shoot: function(item, xt, yt, size, fraction) {
            entityList.push(new Bullet(item.x + size*fraction/2, item.y + size*fraction/2, xt - item.x, yt - item.y, 0, 0, 0, 1000, 50, 50, "web.svg"));
        },
        "feral": true,
        "cooldown": 15,
        "point": false,
    },
    {
        ...
        shoot: function(item, xt, yt, size, fraction) {
            entityList.push(new Bullet(item.x + size*fraction/2, item.y + size*fraction/2, xt - item.x, yt - item.y, 40, 0.03, 0.1, 70, 10, 200, "goop.svg"));
        },
        "feral": false,
        "cooldown": 40,
        "point": true,
    ...
    },
    {
        ...
        shoot: function(item, xt, yt, size, fraction) {
            entityList.push(new Bullet(item.x + size*fraction/2, item.y + size*fraction/2, xt - item.x, yt - item.y, 40, 0.03, 0.1, 70, 10, 10, "goop.svg"));
        },
        "feral": true,
        "cooldown": 4,
        "point": true,
    },
    {
        ...
        shoot: function(item, xt, yt, size, fraction) {
            for (let i = 0; i < 10; i++) {
                entityList.push(new Bullet(item.x + size*fraction/2, item.y + size*fraction/2, xt - item.x, yt - item.y, 50, 0.1, 1, 40, 20, 20, "stink.svg"));
            }
        },
        "feral": true,
        "cooldown": 2,
